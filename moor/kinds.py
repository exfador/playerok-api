...
class IngressPoint(Enum):
    ...
    STARS_NEW = 3
    LEDGER_SETTLED = 4
    LEDGER_AUTO_SETTLED = 5
    LEDGER_REVERSED = 6
    LEDGER_DISPUTE = 7
    LEDGER_DISPUTE_CLEARED = 8
    LEDGER_STAGE = 9
    SKU_PAID = 10
    SKU_SHIPPED = 11
    STARS_REMOVED = 12
...
class WafInterceptError(Exception):
...
class UpstreamGraphError(Exception):
...
class TransportShakeError(Exception):
...
class ShadowAccountError(Exception):
