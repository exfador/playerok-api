...
- [Ответственность](#️-ответственность)
...
Подробные имена файлов и полей конфига — в разделе [Конфигурация](#️-конфигурация).
...
**Windows:** можно использовать [`start.bat`](start.bat) (запускает `python main.py`).
